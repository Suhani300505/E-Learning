...
import BannerImg from '../../assets/img/Education_img.png'
      ...
      <section>
        <div className="container py-14 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-8 space-y-6 md:space-y-0">
            ...
            <div className="flex justify-center items-center">
               <motion.img initial={{opacity:0, x:-50}} whileInView={{opacity:1, x:0}} viewport={{once:true}} transition={{duration:0.5, ease:"easeInOut"}} src={BannerImg} alt="" className='w-[350px] md:max-w-[450px] object-cover drop-shadow' /> 
            </div>
            {/* Banner Text */}
            <div className="flex flex-col justify-center">
                <div className="text-center md:text-left space-y-12">
                    <motion.h1 initial={{opacity:0, scale:0.5}} whileInView={{opacity:1, scale:1}} viewport={{once:true}} teansition={{duration:0.5}} className='text-3xl md:text-4xl font-bold !leading-sung'>The World's Leading Online Learning Platform</motion.h1>
